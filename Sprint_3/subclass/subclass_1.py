...
class FullTimeEmployee(Employee):
    ...
    def get_unpaid_vacation(self, vacation_start, need_day):
        vacation_start = str(vacation_start)
        need_day = int(need_day)
        return f'Начало неоплачиваемого отпуска: {vacation_start}, продолжительность: {need_day} дней.'
